...
function addRenderCallback(fn) {
  ...
  return () => {
    const idx = renderCallbacks.indexOf(fn);
...
function useReveal(options = {}) {
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(([entry]) => {
      ...
      rootMargin: options.margin || '-120px',
      threshold: 0
    });
    obs.observe(el);
...
function Typewriter({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ref: ref,
    className: className
  }, chars.map((char, i) => /*#__PURE__*/React.createElement(motion.span, {
    key: i,
    initial: {
      opacity: 0,
      y: 14,
  ...
  }, char === ' ' ? '\u00A0' : char)), /*#__PURE__*/React.createElement(motion.span, {
    initial: {
      opacity: 0
    },
    animate: {
...
function Navbar() {
  ...
  return /*#__PURE__*/React.createElement(motion.nav, {
    ...
    "aria-label": "Mostafa Abohamar"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xl md:text-2xl font-bold text-txtprimary tracking-tight"
  }, "Mostafa Abohamar")), /*#__PURE__*/React.createElement("div", {
    className: "hidden md:flex items-center gap-8"
  }, links.map(l => /*#__PURE__*/React.createElement("a", {
    key: l.href,
    href: l.href,
    className: "text-txtsecondary hover:text-electric transition-colors duration-300 text-sm font-medium tracking-wide relative group"
  }, l.label, /*#__PURE__*/React.createElement("span", {
    className: "absolute -bottom-1 left-0 w-full h-[2px] bg-electric origin-left scale-x-0 transition-transform duration-300 ease-out group-hover:scale-x-100"
  })))), /*#__PURE__*/React.createElement("button", {
    onClick: () => setMobileOpen(!mobileOpen),
    className: "md:hidden text-txtprimary p-2",
  ...
  })))), /*#__PURE__*/React.createElement(AnimatePresence, null, mobileOpen && /*#__PURE__*/React.createElement(motion.div, {
    key: "mobile-menu",
    initial: {
      opacity: 0,
      x: '100%'
    ...
    className: "text-2xl text-txtsecondary hover:text-electric transition-colors font-medium"
  }, l.label)))));
}
function Hero() {
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Code Is A Passion"), /*#__PURE__*/React.createElement("h1", {
  ...
  }, "MERN Stack \xB7 AI Integration \xB7 Real-Time Systems"), /*#__PURE__*/React.createElement(motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
    ...
    href: "#projects",
    className: "px-8 py-3.5 bg-neon text-dark font-semibold rounded-lg hover:neon-glow active:scale-[0.97] transition-all duration-200"
  }, "View My Work"), /*#__PURE__*/React.createElement("a", {
    href: "#contact",
    className: "px-8 py-3.5 border border-neon/40 text-neon font-semibold rounded-lg hover:bg-neon/10 hover:border-neon active:scale-[0.97] transition-all duration-200"
  }, "Contact Me"))));
}
function About() {
  const stats = [{
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "text-3xl md:text-5xl font-black text-txtprimary mb-4"
  }, "About Me"), /*#__PURE__*/React.createElement("div", {
    className: "w-16 h-1 bg-neon rounded-full mb-12"
  })), /*#__PURE__*/React.createElement("div", {
    className: "grid md:grid-cols-2 gap-12 items-center"
  }, /*#__PURE__*/React.createElement(Reveal, {
    delay: 0.1
  }, /*#__PURE__*/React.createElement("div", {
    className: "space-y-5 text-txtsecondary leading-relaxed"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-lg"
  }, "Backend developer with hands-on project experience building scalable REST APIs, real-time systems, and AI-integrated backend services using Node.js, TypeScript, Express, and MongoDB."), /*#__PURE__*/React.createElement("p", {
    className: "text-lg"
  }, "Currently engineering ", /*#__PURE__*/React.createElement("span", {
    className: "text-neon font-semibold"
  }, "EduBox"), ", a full-featured LMS with Socket.IO real-time collaboration, Gemini AI grading, and Swagger-documented APIs."), /*#__PURE__*/React.createElement("p", {
    className: "text-lg"
  }, "Skilled in JWT/OAuth authentication, Role-Based Access Control, OWASP security principles, Redis caching, and Dockerized CI/CD deployments. Committed to writing secure, production-ready code with strong attention to performance, maintainability, and clean architecture."))), /*#__PURE__*/React.createElement(Reveal, {
    delay: 0.3
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-4"
  }, stats.map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "bg-surfaced border border-border rounded-lg p-6 text-center hover:border-neon/40 transition-all duration-300"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-3xl md:text-4xl font-black text-electric mb-1 leading-tight break-words"
  }, typeof s.value === 'number' ? /*#__PURE__*/React.createElement(CountUp, {
    end: s.value
  }) : s.value, s.suffix), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-txtsecondary uppercase tracking-widest"
  }, s.label))))))));
}
function Skills() {
  const skillGroups = [{
  ...
  }, skillGroups.map((group, gi) => /*#__PURE__*/React.createElement(Reveal, {
    key: gi,
    delay: gi * 0.1
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(motion.h3, {
    initial: {
      opacity: 0,
      x: -30
    },
  ...
  }, group.category), /*#__PURE__*/React.createElement(RevealStagger, null, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-3"
  }, group.items.map(skill => /*#__PURE__*/React.createElement(RevealItem, {
    key: skill
  }, /*#__PURE__*/React.createElement("div", {
    className: "badge flex items-center gap-2 px-4 py-2 bg-surfaced border border-border rounded-lg text-sm text-txtsecondary cursor-default"
  }, /*#__PURE__*/React.createElement("span", {
...
function Projects() {
  ...
  const Card = ({
    ...
    return /*#__PURE__*/React.createElement(RevealItem, null, /*#__PURE__*/React.createElement("a", {
      href: project.url,
      target: "_blank",
      ...
      className: "text-xl font-bold text-txtprimary group-hover:text-electric transition-colors"
    }, project.title), /*#__PURE__*/React.createElement("svg", {
      width: "20",
      height: "20",
      viewBox: "0 0 24 24",
      fill: "none",
      ...
      className: "text-txtsecondary text-sm leading-relaxed mb-3"
    }, project.desc), project.bullets && /*#__PURE__*/React.createElement("ul", {
      className: "space-y-1.5 mb-5"
    }, project.bullets.map((b, i) => /*#__PURE__*/React.createElement("li", {
      key: i,
      className: "text-xs text-txtsecondary flex items-start gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      ...
      key: tag,
      className: "text-xs font-mono text-electric/70 bg-electric/5 px-2 py-1 rounded"
    }, tag)))))));
  };
  return /*#__PURE__*/React.createElement("section", {
    className: "relative py-28 px-6"
    ...
    className: "w-16 h-1 bg-neon rounded-full mb-12"
  })), /*#__PURE__*/React.createElement(RevealStagger, {
    delay: 0.1
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid md:grid-cols-2 gap-6 tilt-wrap"
...
function CoreCompetencies() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "grid md:grid-cols-2 gap-6 tilt-wrap"
  }, competencies.map((c, i) => /*#__PURE__*/React.createElement(RevealItem, {
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-surfaced border border-border rounded-lg p-8 hover:border-electric/30 transition-all duration-300 hover:-translate-y-1 h-full flex flex-col"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-xs font-mono text-neon/50 tracking-widest mb-3"
  }, c.icon), /*#__PURE__*/React.createElement("h3", {
    className: "text-xl font-bold text-txtprimary mb-3"
  }, c.title), /*#__PURE__*/React.createElement("p", {
    className: "text-txtsecondary leading-relaxed"
  }, c.text))))))));
}
function Contact() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setToast({
        show: true,
        type: 'error',
        text: 'Could not send. Try emailing me directly at deshafeisty@gmail.com'
      });
      clearTimeout(toastTimerRef.current);
      toastTimerRef.current = setTimeout(() => setToast({
        show: false,
  ...
  const socials = [{
    label: 'GitHub',
    url: 'https://github.com/Desha-Feisty',
    icon: 'M'
  }, {
    label: 'LinkedIn',
    url: 'https://www.linkedin.com/in/mostafa-abohamar-aa135936a/',
    icon: 'in'
  }, {
    label: 'Email',
    url: 'mailto:deshafeisty@gmail.com',
    icon: '@'
  }];
  const SocialIcon = ({
    label
  }) => {
    if (label === 'GitHub') return /*#__PURE__*/React.createElement("svg", {
      width: "18",
      height: "18",
      viewBox: "0 0 24 24",
      fill: "currentColor"
    ...
    if (label === 'LinkedIn') return /*#__PURE__*/React.createElement("svg", {
      width: "18",
      height: "18",
      viewBox: "0 0 24 24",
      fill: "currentColor"
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "space-y-6",
    noValidate: true
  }, ['name', 'email', 'message'].map(field => /*#__PURE__*/React.createElement("div", {
    key: field,
    className: "relative"
  }, /*#__PURE__*/React.createElement("label", {
    htmlFor: field,
    className: `absolute left-4 transition-all duration-300 pointer-events-none ${focusedField === field || formState[field] ? '-top-2.5 text-xs text-electric bg-dark px-1' : 'top-3.5 text-sm text-txtsecondary'}`
  }, field.charAt(0).toUpperCase() + field.slice(1)), field === 'message' ? /*#__PURE__*/React.createElement("textarea", {
    id: field,
    name: field,
    ...
    type: "submit",
    disabled: submitting,
    className: `ripple w-full py-3.5 rounded-lg font-semibold transition-all duration-300 ${submitting ? 'bg-neon/50 text-dark cursor-wait' : 'bg-neon text-dark hover:neon-glow'}`
  }, submitting ? 'Sending...' : 'Send Message'))), /*#__PURE__*/React.createElement(Reveal, {
    delay: 0.3
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col justify-center gap-8"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-lg font-semibold text-txtprimary mb-2"
  }, "Let's build something together"), /*#__PURE__*/React.createElement("p", {
    className: "text-txtsecondary leading-relaxed"
  }, "Whether it's a full-stack application, a real-time system, or AI integration, I'm always open to discussing new projects and opportunities.")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-8 h-8 flex items-center justify-center rounded bg-electric/10 text-electric group-hover:bg-electric/20 group-hover:scale-110 transition-all duration-200"
    ...
    d: "M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3"
  }))))))))), /*#__PURE__*/React.createElement(AnimatePresence, null, toast.show && /*#__PURE__*/React.createElement(motion.div, {
    key: "toast",
    role: "alert",
    initial: {
      opacity: 0,
    ...
    className: `fixed bottom-6 right-6 z-50 px-5 py-3 rounded-lg shadow-2xl ${toast.type === 'success' ? 'bg-green-500/20 border border-green-500/50 text-green-400' : 'bg-red-500/20 border border-red-500/50 text-red-400'}`,
    style: {
...
function SectionDivider() {
  ...
  useEffect(() => {
    ...
    const onLenisScroll = () => {
      ...
      if (line) {
        line.style.transform = `scaleX(${visibility})`;
        line.style.opacity = visibility;
      }
      if (glow) {
        glow.style.transform = `scale(${visibility})`;
        glow.style.opacity = visibility;
      }
      /* Ripple ring expands as section passes through center */
      if (ring) {
        ring.style.transform = `scale(${0.5 + visibility * 1.5})`;
        ring.style.opacity = visibility * 0.3;
      }
    };
    if (window.lenis) {
      window.lenis.on('scroll', onLenisScroll);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    className: "h-20 md:h-24 flex items-center justify-center pointer-events-none relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    ref: ringRef,
    className: "absolute w-16 h-16 rounded-full border border-neon/30",
    style: {
      transform: 'scale(0.5)',
      opacity: 0
    }
    ...
    ref: lineRef,
    className: "absolute left-[15%] right-[15%] h-px origin-left",
    style: {
    ...
    style: {
      background: '#00D4FF',
      boxShadow: '0 0 16px rgba(0,212,255,0.7), 0 0 40px rgba(0,212,255,0.25), 0 0 80px rgba(0,212,255,0.1)',
      transform: 'scale(0)',
      opacity: 0
    }
  }));
...
function Footer() {
  ...
  return /*#__PURE__*/React.createElement(motion.footer, {
    ...
    className: "text-lg font-black text-neon tracking-tight"
  }, "MA"), /*#__PURE__*/React.createElement("span", {
    className: "text-sm text-txtsecondary"
  }, "\xA9 2026 Mostafa Abohamar")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-6"
  }, /*#__PURE__*/React.createElement("a", {
    href: "https://github.com/Desha-Feisty",
    target: "_blank",
    rel: "noopener noreferrer",
    className: "text-txtsecondary hover:text-electric transition-colors duration-200 text-sm",
    "aria-label": "GitHub"
  }, "GitHub"), /*#__PURE__*/React.createElement("a", {
    href: "https://www.linkedin.com/in/mostafa-abohamar-aa135936a/",
    target: "_blank",
    rel: "noopener noreferrer",
    className: "text-txtsecondary hover:text-electric transition-colors duration-200 text-sm",
    "aria-label": "LinkedIn"
  }, "LinkedIn"), /*#__PURE__*/React.createElement("a", {
    href: "mailto:deshafeisty@gmail.com",
    className: "text-txtsecondary hover:text-electric transition-colors duration-200 text-sm",
    "aria-label": "Email"
...
function SectionWrapper({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    id: id,
    className: `section-scroll-wrap ${className}`
  }, children);
}
function App() {
  useEffect(() => {
    ...
    const removeCb = addRenderCallback(time => {
      lenis.raf(time);
    });
    return () => {
      removeCb();
  ...
  }, /*#__PURE__*/React.createElement(ParticleBackground, null), /*#__PURE__*/React.createElement(ScrollProgress, null), /*#__PURE__*/React.createElement(Navbar, null), /*#__PURE__*/React.createElement(Hero, null), /*#__PURE__*/React.createElement(SectionWrapper, {
    id: "about"
  }, /*#__PURE__*/React.createElement(About, null)), /*#__PURE__*/React.createElement(SectionDivider, null), /*#__PURE__*/React.createElement(SectionWrapper, {
    id: "skills"
  }, /*#__PURE__*/React.createElement(Skills, null)), /*#__PURE__*/React.createElement(SectionDivider, null), /*#__PURE__*/React.createElement(SectionWrapper, {
    id: "projects"
  }, /*#__PURE__*/React.createElement(Projects, null)), /*#__PURE__*/React.createElement(SectionDivider, null), /*#__PURE__*/React.createElement(SectionWrapper, {
    id: "competencies"
  }, /*#__PURE__*/React.createElement(CoreCompetencies, null)), /*#__PURE__*/React.createElement(SectionDivider, null), /*#__PURE__*/React.createElement(SectionWrapper, {
    id: "contact"
